...
ServerChannel? _isolateServerChannel;
...
Future<void> initializeNetworkTools() async {
  ...
  networkToolsSendPort = await networkToolsReceivePort.next<SendPort>();

  _isolateServerChannel = ServerChannel(
...
Future<List<(Future<String>, String)>> scanIps() async {
  assert(_isolateServerChannel != null, "Network tools not initialized.");

  var result = await _isolateServerChannel!.invoke<List<SendableActiveHost>>("scan_ips");
