...
class _AdminNavigationViewState extends State<AdminNavigationView> {
  ...
  void initState() {
    ...
    _previousSelectedIndex = context.read<NavigationBloc>().state.selectedIndex ?? 0;
  }
  ...
  @override
  Widget build(BuildContext context) {
    final selectedIndex = context.select((NavigationBloc bloc) => bloc.state.selectedIndex);
    final previous = _previousSelectedIndex;
    if (selectedIndex != null) {
      _previousSelectedIndex = selectedIndex;
    }

    return RouteIndexMapper.provide(
        ...
        return BlocListener<NavigationBloc, NavigationState>(
          ...
          child: NavigationView(
            ...
            pane: NavigationPane(
              ...
              selected: selectedIndex ?? previous,
