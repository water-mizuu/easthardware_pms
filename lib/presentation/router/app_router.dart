...
import 'package:easthardware_pms/presentation/views/settings/system_backup.dart';
          ...
          branches: [
            ...
            StatefulShellBranch(
              ...
              routes: [
                ...
                TypedGoRoute(
                  route: AppRoutes.admin.editInvoice,
            ...
            StatefulShellBranch(
              ...
              routes: [
                ...
                TypedGoRoute(
                  route: AppRoutes.admin.profitLossReport,
                  builder: (context, state) => const ProfitLossReportPage(),
                ),
                TypedGoRoute(
                  route: AppRoutes.admin.businessSnapshotReport,
